...
# network saved path
Netsaved_PATH = './TrainedNetwork/LSTMnet_1out150ms_noscale_smoothed100n-0n-100d.h5'
HISTORYsaved_PATH = './TrainedNetwork/history_1out150ms_noscale_smoothed100n-0n-100d.pickle'
...
def loaddata(dir):
    ...
    dataset = read_csv(dir, index_col=None, header=0)
    # drop rows with NaN values
